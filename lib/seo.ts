...
export const PUBLIC_ROUTES = ['/', '/bulk-domain-search', '/how-it-works', '/about', '/advertise', '/glossary', '/guides', '/guides/domain-registration-count', '/guides/domain-extensions-explained', '/guides/compare-domain-names'];
