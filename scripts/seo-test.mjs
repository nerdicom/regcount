...
const routes = ['/', '/bulk-domain-search', '/how-it-works', '/about', '/advertise', '/glossary', '/guides', '/guides/domain-registration-count', '/guides/domain-extensions-explained', '/guides/compare-domain-names'];
...
try {
  ...
  console.log('Passed: ten public pages, unique metadata, server-rendered content, canonicals, sitemap, robots, JSON-LD, query/private exclusions, unknown-guide 404, www redirect, social PNG, and optimized logo.');
} finally {
