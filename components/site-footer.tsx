...
export function SiteFooter() {
  return <footer className="product-footer">
    <div className="footer-main">
      ...
      <nav aria-label="About RegCount"><h2>RegCount</h2><Link href="/about">About the project</Link><Link href="/how-it-works">Data & methodology</Link><Link href="/login">Your account <ArrowUpRight size={13}/></Link><Link href="/privacy">Privacy policy</Link><Link href="/data-deletion">Data deletion</Link></nav>
    </div>
