...
export default function BulkSearchPage() {
  return <><RegCount initialView="bulk"><SearchContent bulk/></RegCount><StructuredData value={breadcrumbData([{ name: 'Home', path: '/' }, { name: 'Bulk domain search', path: '/bulk-domain-search' }])}/></>;
}
